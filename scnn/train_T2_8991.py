...
class SCNN(nn.Module):
    def __init__(self, T: int):
        ...
        # conv2: 8 -> 32
        self.conv2 = layer.Conv2d(8, 32, 5, bias=True)
        ...
        # flatten: 32 * 4 * 4 = 512
        self.fc1 = layer.Linear(32 * 4 * 4, 192, bias=True)
        ...
        self.fc2 = layer.Linear(192, 128, bias=True)
        ...
        self.fc3 = layer.Linear(128, 10, bias=True)
