...
// flatten: 16 * 4 * 4 = 256
#define FC1_IN  (C2_OUT * 4 * 4)  // 16*4*4 = 256
#define FC1_OUT 160
#define FC2_IN  FC1_OUT           // 128
#define FC2_OUT 96
#define FC3_IN  FC2_OUT           // 64
#define FC3_OUT 10
...
#define FC1_N        FC1_OUT      // 128
#define FC1_NPAD     160          // >=FC1_OUT 且 16 的倍数

// FC2: [B, 128] x [128, 64]
#define FC2_K        FC2_IN       // 128
#define FC2_KPAD     160
#define FC2_N        FC2_OUT      // 64
#define FC2_NPAD     96           // >=FC2_OUT 且 16 的倍数
