...
// WMMA tile 尺寸（Tensor Core 使用 16x16x16）
#define WMMA_M 16
#define WMMA_N 16
#define WMMA_K 16

// FC1 WMMA 维度
#define FC1_K        FC1_IN        // 512
#define FC1_N        FC1_OUT       // 192
// Npad 要 >= FC1_OUT 且是 16 的倍数，这里 192 本身就是 16 的倍数
#define FC1_NPAD     192

// FC2 WMMA 维度
#define FC2_K        FC2_IN        // 192
// Kpad 也取等于 192，方便 WMMA
#define FC2_KPAD     192
#define FC2_N        FC2_OUT       // 128
#define FC2_NPAD     128
